...
using System.IO;
using System.Text.Json; // Biblioteca para trabalhar com JSON
...
namespace FluxoCaixaApp
{
    public partial class Form1 : Form
    {
        ...
        private const string CaminhoArquivo = "fluxoCaixa.json"; // Arquivo JSON para salvar os dados
        ...
        // Método para carregar os dados ao iniciar o programa
        ...
        // Capturar o fechamento do formulário para salvar os dados
    ...
    // Classe para representar os dados salvos
    public class DadosSalvos
    {
        public decimal SaldoAtual { get; set; }
        public decimal TotalReceitas { get; set; }
        public decimal TotalDespesas { get; set; }
        public List<Transacao> Receitas { get; set; } = new List<Transacao>(); // Inicializa a lista
        public List<Transacao> Despesas { get; set; } = new List<Transacao>(); // Inicializa a lista
    }
}
